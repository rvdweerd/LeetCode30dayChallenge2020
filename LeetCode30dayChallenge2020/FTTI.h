// FTTI.h
// Fast Triangle Intersection Algorithm
// Based on "Faster Triangle-Triangle Intersection Tests", Devillers, Guigue (HAL-intria-00072100)
// https://github.com/risgpta/Fast-Triangle-Triangle-Intersection-Algorithm
...
{
    std::cin >> _p1.x >> _p1.y >> _p1.z;
    std::cin >> _q1.x >> _q1.y >> _q1.z;
    std::cin >> _r1.x >> _r1.y >> _r1.z;
    std::cin >> _p2.x >> _p2.y >> _p2.z;
    std::cin >> _q2.x >> _q2.y >> _q2.z;
    std::cin >> _r2.x >> _r2.y >> _r2.z;
}
